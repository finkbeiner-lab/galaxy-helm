...
def extract_cell_info(var_dict, read_path, write_path):
    ...
    'BlobCentroidY','BlobCentroidX_RefIntWeighted', 'BlobCentroidY_RefIntWeighted', 'BlobCircularity', 'Spread', 'Convexity',
...
if __name__ == '__main__':
    ...
    utils.save_user_args_to_csv(args, write_path, 'extract')
