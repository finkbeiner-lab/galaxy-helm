...
if __name__ == '__main__':
    ...
    parser.add_argument("--shifts_dict_path",
        help="Optional path to calculated shifts dictionary.")
    ...
    CHANNEL_SET = set()
    if args.shifts_dict_path != '':
        SHIFTS = pickle.load(open(args.shifts_dict_path, 'rb'))
    else:
    ...
    utils.save_user_args_to_csv(args, PATH_SHIFT_CROPPED_IMAGES, 'shift_crop_versions')
