...
def background_correction(image_stack_list, DTYPE, BG_REMOVAL_TYPE, QC_PATH, OUTPUT_PATH, BG_WELL_DICT, BG_WELL):
    ...
    for im_tokens in image_stack_list:
        ...
        tif_output = TIFF.open(os.path.join(OUTPUT_PATH, background_corrected_image_name), mode='w')
...
if __name__ == '__main__':
    ...
    utils.save_user_args_to_csv(args, write_path, 'background_removal_distributed'+'_'+timestamp)
